...
const getTableContents = () => {
  ...
  for(const product of products) {
    ...
    <td><button class="btn btn-danger" onclick="deleteProduct(${product.id})">Ištrinti</button>
    </td>
    <td><button class="btn btn-success" onclick="setEdit(${product.id})">Atnaujinti</button>
    </td>
  </tr>`;
  }
...
const createNewRecord = (e) => {
  //preventDefault - prevencija nuo įprastinio elgesio
  e.preventDefault();
  const newProduct = {
